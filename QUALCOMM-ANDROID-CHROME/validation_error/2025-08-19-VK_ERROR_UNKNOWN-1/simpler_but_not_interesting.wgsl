...
)
{
    ...
    while (baseIndex <= treeIndex)
    {
        ...
        else
        {
            ...
            loop
            {
                if (((firstTrailingBit((1583906662i), )) != (countTrailingZeros((countLeadingZeros((firstTrailingBit((dot4I8Packed((max((1327820528u), ((extractBits((2651895023u), 2u, (u32(8i, ) - 1u), )) + ((2405041856u) % 1570793u)), )), (517682537u), )), )), )), ))) || (ub.values[1] == 18i))
                {
                    break;
                }
                return;
