...
)
{
    ...
    while (baseIndex <= treeIndex)
    {
        ...
        else
        {
            ...
            loop
            {
                if (/* known value: true */ (/* arbitrary expression: */ (/* arbitrary expression: */ firstTrailingBit((/* arbitrary expression: */ 1583906662i), )) != (/* arbitrary expression: */ countTrailingZeros((/* arbitrary expression: */ countLeadingZeros((/* arbitrary expression: */ firstTrailingBit((/* arbitrary expression: */ dot4I8Packed((/* arbitrary expression: */ max((/* arbitrary expression: */ 1327820528u), (/* arbitrary expression: */ (/* arbitrary expression: */ extractBits((/* arbitrary expression: */ 2651895023u), 2u, (/* known value: 7u */ u32((/* known value: 8i */ ub.values[2]), ) - 1u), )) + (/* arbitrary expression: */ (/* arbitrary expression: */ 2405041856u) % 1570793u)), )), (/* arbitrary expression: */ 517682537u), )), )), )), ))) || (/* known value: true */ ub.values[1] == 18i))
                {
                    break;
                }
                return;
