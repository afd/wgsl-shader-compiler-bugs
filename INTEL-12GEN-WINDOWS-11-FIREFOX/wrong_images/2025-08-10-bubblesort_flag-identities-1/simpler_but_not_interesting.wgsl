...
{
    return select((a < b), (a > b), gl_FragCoord.y < ((f32(256i, ) - ((15537770f - ((ub.injectionSwitch[1]) + ((ub.injectionSwitch[0]) + 8799199f))) - ((((ub.injectionSwitch[1]) + (((ub.injectionSwitch[1]) + 16086922f) - 6440397f)) - ((((1585883f + (f32(256i, ) - 254f) * 3299814f) + 6033292f) - 8943790f) + f32(256i, ))) + 2367057f))) * (f32(ub.resolution.y, ) / 2.0)), );
}
