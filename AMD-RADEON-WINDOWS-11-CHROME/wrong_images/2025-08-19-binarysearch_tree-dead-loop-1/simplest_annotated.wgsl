    ...
    vec4f
{
    ...
    {
        /* dead code fragment: */
        if (/* known value: false */ ub.values[1] != 18i)
        {
            continue;
        }
        if (/* known value: true */ (/* known value: 18i */ (/* known value: 6i */ (/* known value: 5i */ (/* known value: 12i */ ub.values[3]) - 7i) + 1i) + 12i) == ub.values[1])
        {
            break;
        }
        discard;
