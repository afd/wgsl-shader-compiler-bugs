    ...
    vec4f
{
    ...
    let ipos = vec2(i32((/* div by one */ (pos.x * 16) / (/* known value: 1.0f */ (/* known value: 1f */ (/* known value: 1f */ (/* known value: 1f */ 14044009f - (/* known value: 14044008f */ 1513092f + (/* known value: 2f */ (/* known value: 0f */ f32((/* known value: 256i */ resolution[1]), ) - 256f) + 2f) * 6265458f)) + 0f) * 1f + 0f) * 1f)), ), i32(pos.y * 16, ), );
