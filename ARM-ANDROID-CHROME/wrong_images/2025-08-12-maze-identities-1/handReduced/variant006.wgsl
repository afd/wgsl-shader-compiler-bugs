    ...
    vec4f
{
    ...
    let ipos = vec2(i32((/* div by one */ (pos.x * 16) /  (/* known value: 1f */ 12530917f - (/* known value: 12530916f */ (/* known value: 2f */ f32((/* known value: 256i */ resolution[1]), ) - 254f) * 6265458f))), ), i32(pos.y * 16, ), );
