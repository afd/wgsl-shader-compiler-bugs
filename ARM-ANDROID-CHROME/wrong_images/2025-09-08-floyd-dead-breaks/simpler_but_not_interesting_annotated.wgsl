...
fn runFloyd()
{
    ...
    loop
    {
        ...
        for (var i = 0; i < NUM_NODES; i++)
        {
            ...
            {
                /* dead code fragment: */
                if (/* known value: false */ !(/* known value: true */ (/* arbitrary expression: */ (/* arbitrary expression: */ i32(1u, )) <= 1i) || (/* known value: true */ !(/* known value: false */ 0i != input[2][0].unusedPadding[0]))))
                {
                    break;
                }
                else
